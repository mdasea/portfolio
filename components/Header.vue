    ...
    <header class="bg-white">
      <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <PopoverGroup class="hidden lg:flex lg:gap-x-12">
          <NuxtLink to="/portfolio" class="text-sm/6 font-semibold text-gray-900">Portfolio</NuxtLink>
          <NuxtLink to="/" class="text-sm/6 font-semibold text-gray-900">About</NuxtLink>
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="#" class="text-sm/6 font-semibold text-gray-900">LinkedIn <span aria-hidden="true">&rarr;</span></a>
        </div>
      </nav>
        ...
        <DialogPanel class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              ...
              <div class="py-6">
                <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Linkin</a>
              </div>
            </div>
          </div>
        </DialogPanel>
